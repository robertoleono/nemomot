// ============================================================
// NEMOMOT CART SYSTEM
// PayPal JS SDK v2 — modern integration
// ============================================================
...
function renderPayPalButton() {
  ...
  loadPayPalSDK(() => {
    window.paypal.Buttons({
      ...
      onCancel: function() {
        window.location.href = PAYPAL_CONFIG.cancelUrl;
      },
...
function updateCartUI() {
  ...
  const footerEl = drawer.querySelector('.cart-footer');
...
function injectCartStyles() {
  ...
  style.textContent = `
    ...
    .cart-close {
      ...
      font-size: 14px; color: var(--ink-muted, #6b6560);
    ...
    .cart-empty {
      font-size: 13.5px; color: var(--ink-muted, #6b6560);
      font-style: italic; font-family: var(--serif, Georgia);
      padding: 1rem 0;
    }
    .cart-item {
      display: flex; justify-content: space-between; align-items: flex-start;
      padding: 1rem 0; border-bottom: .5px solid var(--rule, #ddd8ce); gap: 1rem;
    }
    ...
    .cart-item-remove {
      background: none; border: none; cursor: pointer;
      font-size: 11px; color: var(--ink-faint, #999);
